...
class coin_generation(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.img = pygame.transform.scale(pygame.image.load('coin.png'), (60//self.weight,60//self.weight))
...
class ownMovement(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.car = pygame.transform.scale(pygame.image.load('redcar.png'), (50,70))
