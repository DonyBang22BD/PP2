...
class ButtonPen(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("penbuttonimages.png"),(40,40))
...
class ButtonRightTriangle(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("righttriangle.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
...
class ButtonEraser(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("eraserbutton.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
...
class ButtonRombus(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("rombus.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
...
class ButtonEquileiteral(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("equileiteral.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
